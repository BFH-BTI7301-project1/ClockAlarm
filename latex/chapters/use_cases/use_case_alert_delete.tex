\section{Delete an alert: Simple and Periodic alert}\label{subsec:usecase_delete_simple_alert}
...
\section{Delete an alert: E-mail sender}\label{subsec:usecase_delete_email_sender}
