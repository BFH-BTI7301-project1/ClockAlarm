\subsection{Delete an alert: Simple and Periodic alert}\label{subsec:usecase_delete_simple_alert}
...
\subsection{Delete an alert: E-mail sender}\label{subsec:usecase_delete_email_sender}
