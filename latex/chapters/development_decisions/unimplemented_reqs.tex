...
\begin{itemize}
    ...
    \item \textbf{Email alert:} \fullref{subsec:usecase_add_email_sender},
     ...
     \item \textbf{Snooze alert:} \fullref{subsec:usecase_snooze_alert}

     \item \textbf{Auto start:} \fullref{subsec:usecase_auto_start},
