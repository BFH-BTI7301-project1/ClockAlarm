...
\begin{enumerate}
	...
	\item \label{itm:second} The application checks if the User entered configuration is valid
	\item The application saves the configuration.
\end{enumerate}
\subsubsection{Extension}
\begin{enumerate}
	\item[\ref{itm:second}.] The application detects that the User entered configuration is invalid
		\begin{enumerate}[i]
