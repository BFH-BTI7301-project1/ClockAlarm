...
\begin{enumerate}
	...
	\item \label{itm:second} The application checks if the file is a valid alert file.
	\item \label{itm:third} The application asks the User which alerts he wants to import.
...
\begin{enumerate}
	...
	\end{enumerate}
	\item[\ref{itm:third}.] The application detects that the User has chosen no alerts.
	\begin{enumerate}[i]
